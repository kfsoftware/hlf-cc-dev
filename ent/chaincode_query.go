...
func (cq *ChaincodeQuery) Where(ps ...predicate.Chaincode) *ChaincodeQuery {
...
func (cq *ChaincodeQuery) QueryTenant() *TenantQuery {
	query := &TenantQuery{config: cq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(chaincode.Table, chaincode.FieldID, selector),
...
// First returns the first Chaincode entity from the query.
// Returns a *NotFoundError when no Chaincode was found.
func (cq *ChaincodeQuery) First(ctx context.Context) (*Chaincode, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{chaincode.Label}
	}
	return nodes[0], nil
}
...
// FirstID returns the first Chaincode ID from the query.
// Returns a *NotFoundError when no Chaincode ID was found.
...
// Only returns a single Chaincode entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when exactly one Chaincode entity is not found.
// Returns a *NotFoundError when no Chaincode entities are found.
func (cq *ChaincodeQuery) Only(ctx context.Context) (*Chaincode, error) {
	...
	case 0:
		return nil, &NotFoundError{chaincode.Label}
	default:
		return nil, &NotSingularError{chaincode.Label}
	}
}
...
// OnlyID is like Only, but returns the only Chaincode ID in the query.
// Returns a *NotSingularError when exactly one Chaincode ID is not found.
...
func (cq *ChaincodeQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = &NotSingularError{chaincode.Label}
	}
	return
}
...
func (cq *ChaincodeQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
	if err := cq.Select(chaincode.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
// Clone returns a duplicate of the ChaincodeQuery builder, including all associated steps. It can be
...
func (cq *ChaincodeQuery) Clone() *ChaincodeQuery {
	...
	return &ChaincodeQuery{
		...
		predicates: append([]predicate.Chaincode{}, cq.predicates...),
...
func (cq *ChaincodeQuery) GroupBy(field string, fields ...string) *ChaincodeGroupBy {
	group := &ChaincodeGroupBy{config: cq.config}
...
func (cq *ChaincodeQuery) Select(fields ...string) *ChaincodeSelect {
	...
	return &ChaincodeSelect{ChaincodeQuery: cq}
}

func (cq *ChaincodeQuery) prepareQuery(ctx context.Context) error {
...
func (cq *ChaincodeQuery) sqlAll(ctx context.Context) ([]*Chaincode, error) {
	var (
		nodes       = []*Chaincode{}
		withFKs     = cq.withFKs
		_spec       = cq.querySpec()
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, chaincode.ForeignKeys...)
	}
	_spec.ScanValues = func(columns []string) ([]interface{}, error) {
		node := &Chaincode{config: cq.config}
	...
	if query := cq.withTenant; query != nil {
		...
		nodeids := make(map[int][]*Chaincode)
		for i := range nodes {
			if nodes[i].tenant_chaincodes == nil {
				continue
			}
			fk := *nodes[i].tenant_chaincodes
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "tenant_chaincodes" returned %v`, n.ID)
			}
			for i := range nodes {
...
func (cq *ChaincodeQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := cq.querySpec()
	return sqlgraph.CountNodes(ctx, cq.driver, _spec)
}

func (cq *ChaincodeQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (cq *ChaincodeQuery) querySpec() *sqlgraph.QuerySpec {
...
func (cq *ChaincodeQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(cq.driver.Dialect())
	t1 := builder.Table(chaincode.Table)
	columns := cq.fields
	if len(columns) == 0 {
		columns = chaincode.Columns
	}
...
func (cgb *ChaincodeGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ChaincodeGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChaincodeGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = fmt.Errorf("ent: ChaincodeGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChaincodeGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ChaincodeGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChaincodeGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = fmt.Errorf("ent: ChaincodeGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChaincodeGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ChaincodeGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChaincodeGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = fmt.Errorf("ent: ChaincodeGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChaincodeGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("ent: ChaincodeGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChaincodeGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = fmt.Errorf("ent: ChaincodeGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChaincodeGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (cgb *ChaincodeGroupBy) sqlQuery() *sql.Selector {
...
func (cs *ChaincodeSelect) Scan(ctx context.Context, v interface{}) error {
	...
	cs.sql = cs.ChaincodeQuery.sqlQuery(ctx)
...
func (cs *ChaincodeSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ChaincodeSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChaincodeSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = fmt.Errorf("ent: ChaincodeSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChaincodeSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ChaincodeSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChaincodeSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = fmt.Errorf("ent: ChaincodeSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChaincodeSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ChaincodeSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChaincodeSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = fmt.Errorf("ent: ChaincodeSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChaincodeSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("ent: ChaincodeSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChaincodeSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{chaincode.Label}
	default:
		err = fmt.Errorf("ent: ChaincodeSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChaincodeSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
