...
func (cd *ChaincodeDelete) Where(ps ...predicate.Chaincode) *ChaincodeDelete {
...
func (cd *ChaincodeDelete) sqlExec(ctx context.Context) (int, error) {
...
func (cdo *ChaincodeDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{chaincode.Label}
	default:
		return nil
	}
}
